            ...
            <div class="page-content">
                ...
                <form action="{{ route('admin_guest_update_handler') }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <div class="radio"><input type="radio" name="read_only" value="1" id="read_only" @if ($guest->read_only == true || $guest->read_only === null)checked="checked"@endif /> Oui</div>
                        <div class="radio"><input type="radio" name="read_only" value="0" @if (!$guest->read_only)checked="checked"@endif /> Non</div>
                    </div>
